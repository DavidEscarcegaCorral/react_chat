...
export default function Server() {
    ...
    async function handleClear() {
        const confirmed = window.confirm("Estas seguro de que quieres borrar todo el historial de mensajes?");
                            ...
                            {serverStatus.running && (
                                <>
                                    <Typography className="text-sm mt-2">
                                        Protocolo: <strong>{serverStatus.protocol ? serverStatus.protocol.toUpperCase() : ""}</strong>
                                    </Typography>
                                    <Typography className="text-sm">
                                        Clientes: <strong>{serverStatus.clients ? serverStatus.clients.length : 0}</strong>
                                    </Typography>
                                    <Typography className="text-sm">
                                        Mensajes: <strong>{serverStatus.history_len ? serverStatus.history_len : 0}</strong>
                                    </Typography>
                                </>
                            )}
                        </Card>
            ...
            <div className="grid grid-cols-1 gap-4 self-end md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <Typography color="blue-gray" className="font-normal opacity-70">
                        Desde la configuracion del servidor se puede seleccionar
