  ...
  return (
    <div className="relative grid min-h-[100vh] w-screen p-8">
      <div className="flex flex-col-reverse items-center justify-between gap-4 self-start md:flex-row">
        <Card className="h-max w-max flex-row items-center border border-blue-gray-50 py-4 px-5 shadow-lg shadow-blue-gray-900/5">
          ...
          <code className="text-blue-gray-900">
            Seguridad informatica <strong>4:30 Martes/Jueves</strong>
          </code>
        </Card>
      ...
      <div className="flex-col gap-2 pt-32 pb-40 text-center">
        ...
        <form onSubmit={handleRegister}>
          ...
          <div className="mx-auto mt-8 animate-pulse-slow">
            <Button className="w-48 h-12 rounded-full" type="submit">
              Entrar al Chat
            </Button>
          </div>
        </form>
      ...
      <div className="hidden md:block absolute top-[14%] left-[19%] animate-float-slow delay-100">
        <img src="src/assets/vite.png" alt="Vite" className="w-[90px] object-contain opacity-90" />
      </div>
      ...
      <div className="hidden md:block absolute bottom-[22%] right-[7%] animate-float-slow delay-2200">
        <img src="src/assets/html.png" alt="Html" className="w-[80px] object-contain opacity-90" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 self-end md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          >
            ...
            <Typography color="blue-gray" className="font-normal opacity-70">
              Desde la configuración del servidor se puede seleccionar el tipo de protocolo a
              utilizar, ya sea TCP (Transmission Control Protocol) o UDP (User Datagram Protocol).
            </Typography>
          </Card>
        </a>
        <a
        ...
        >
          ...
          >
            ...
            <Typography color="blue-gray" className="font-normal opacity-70">
              Para iniciar el Chat el usuario debe ingresar su nombre, podrá acceder a la sala de
              Chat y enviar mensajes que los otros usuarios podrán ver en tiempo real.
            </Typography>
          </Card>
        </a>
        <a
          ...
          >
            <Typography variant="h5" color="blue-gray" className="mb-3 flex items-center gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="28" height="28">
                ...
                <path
                  d="M5 42c0-7 6-12 13-12s13 5 13 12H5zm14-12c7 0 13 5 13 12h13c0-7-6-12-13-12"
                  stroke="#000"
                  strokeWidth="2"
                  fill="none"
                />
            ...
            <Typography color="blue-gray" className="font-normal opacity-70">
              Nuestro equipo está conformado por David Escarcega, Roberto Cornejo y Manuel Cortez,
